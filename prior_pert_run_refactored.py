...
idata_data = [['EURUSD_idata.json', 'EURUSD.csv'], ['CBA_Daily_idata.json', 'CBA_Daily.csv'], ['4D_Daily_idata.json', '4D_Daily.csv'],
              ['USDJPY_idata.json', 'USDJPY.csv'], ['GBPJPY_idata.json', 'GBPJPY.csv'], ['LYC_Daily_idata.json']]
